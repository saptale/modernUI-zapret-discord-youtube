...
Этот форк включает в себя **удобную графическую оболочку (GUI)** для комфортного управления батниками проекта Zapret. Вам больше не нужно искать нужный файл в огромном списке — всё аккуратно рассортировано по категориям, поддерживает добавление в "Избранное" и имеет защиту от двойного запуска.
