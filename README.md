...
# ВАЖНО
Запускайте от имени администратора, иначе программа не сможет убивать процесс zapret.

## БЫСТРЫЙ СТАРТ

Скачайте из релизов (Releases) последнюю версию и выберите, что по вкусу. Либо только UI приложение, где вы укажете путь к вашему zapret, либо zapret + UI приложение. В первом варианте ярлык и .exe файл. Во втором варианте я кладу .exe и ярлык прямо в корень рядом с .bat файлами.
